				...
				new ComputeServerType(
						...
						optionTypes: [
										...
										new OptionType(
												...
												code: 'omega.baremetal.provision.credential',
												category:'omega.baremetal.provision',
												inputType: OptionType.InputType.CREDENTIAL,
												fieldName: 'type',
												fieldContext: 'credential',
												fieldLabel:'iLO Credentials',
												displayOrder: 2,
												required: true,
												defaultValue:'iLO-device-username-password',
												optionSource:'credentials',
												config: '{"credentialTypes":["ilo-device-username-password"], "localCredentials": false}',
										),
