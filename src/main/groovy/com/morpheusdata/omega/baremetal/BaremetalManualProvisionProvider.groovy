 ...
 */
@Slf4j
class BaremetalManualProvisionProvider implements HostProvisionProvider, HostProvisionProvider.finalizeHostFacet, ProvisionProvider.HypervisorConsoleFacet, ProvisionProvider.SnapshotFacet {
